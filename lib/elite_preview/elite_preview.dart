...
class BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        ...
        border: Border(top: BorderSide(color: C.border, width: .7)),
      ),
      child: SafeArea(
        top: false,
        child: SizedBox(
          ...
          child: Row(
            children: [
              item(0, Icons.home_outlined, Icons.home_rounded, 'الرئيسية'),
              item(
                1,
                  ...
                  child: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: C.bg, width: 5),
                        boxShadow: [
                          BoxShadow(
  ...
  Widget item(int itemIndex, IconData normal, IconData active, String label) {
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 22,
              color: selected ? C.purpleLight : C.secondary,
            ),
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          ...
          const Section(title: 'مباراة اليوم', action: 'عرض الكل'),
          ...
          const Section(title: 'المنافسة', action: 'عرض الترتيب'),
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            shape: BoxShape.circle,
            gradient: LinearGradient(colors: [C.gold, C.purple]),
          ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [C.purpleDark, Color(0xFF20142F), C.surface],
        ),
        border: Border.all(color: C.purple.withOpacity(.55)),
        boxShadow: [
          BoxShadow(color: C.purple.withOpacity(.15), blurRadius: 30),
        ],
      ),
      child: const Column(
        children: [
          Row(
            children: [
              Expanded(
                child: Stat(value: '2,480', label: 'نقاطك'),
              ),
              DividerVertical(),
              Expanded(
                child: Stat(value: '#126', label: 'ترتيبك', gold: true),
              ),
              DividerVertical(),
              Expanded(
                child: Stat(value: '78%', label: 'الدقة', green: true),
              ),
            ],
          ),
          ...
          Divider(color: Color(0x182FFFFFF), height: 1),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.trending_up_rounded, color: C.green, size: 17),
              SizedBox(width: 5),
              Text(
                '+12',
    ...
    return Column(
      children: [
        ...
        Text(
          ...
          style: const TextStyle(color: C.secondary, fontSize: 10),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              const Icon(Icons.emoji_events_outlined, color: C.gold, size: 17),
          ...
          Row(
            children: [
              Expanded(child: team('أرسنال', Icons.shield_rounded)),
              ...
              Expanded(child: team('ليفربول', Icons.shield_rounded)),
            ],
          ),
          ...
          const Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.lock_outline_rounded, color: C.orange, size: 14),
              SizedBox(width: 5),
              Text(
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: C.purple.withOpacity(.35)),
        ),
        child: Column(
          children: [
            Text(
      ...
      children: actions.map((action) {
        return Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                Icon(action.$1, color: C.purpleLight, size: 23),
                const SizedBox(height: 8),
                Text(
                  action.$2,
                  style: const TextStyle(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.emoji_events_rounded, color: C.gold),
          ),
...
class _PredictionPageState extends State<PredictionPage> {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: doublePrediction ? C.gold.withOpacity(.08) : C.surface,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: doublePrediction ? C.gold : C.border),
              ),
              child: Row(
                children: [
                  const Icon(Icons.close_rounded, color: C.gold),
                  ...
                  Icon(
                    ...
                    color: doublePrediction ? C.gold : C.muted,
                  ),
                ],
              ),
            ),
  ...
  Widget score(int value, ValueChanged<int> minus, VoidCallback plus) {
    return Expanded(
      child: Container(
        height: 70,
        decoration: BoxDecoration(
          color: C.surface2,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: C.purple.withOpacity(.4)),
        ),
        child: Row(
          ...
          children: [
            ...
            IconButton(onPressed: plus, icon: const Icon(Icons.add_rounded)),
          ],
        ),
      ),
    );
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(color: selected ? C.purpleLight : C.border),
          ),
          child: Column(
            children: [
              Text(
              ...
              Text(
                title,
                style: TextStyle(
                  color: selected ? Colors.white70 : C.secondary,
                  fontSize: 9,
                ),
              ),
            ],
...
class LeaderboardPage extends StatelessWidget {
  ...
  Widget rank(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: current ? C.purple.withOpacity(.14) : C.surface,
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: current ? C.purple : C.border),
      ),
      child: Row(
        children: [
          SizedBox(
            ...
            child: Text(
              number,
              style: TextStyle(
                color: current ? C.purpleLight : C.secondary,
                fontWeight: FontWeight.w900,
              ),
            ),
          ),
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                const Text('متنبئ محترف', style: TextStyle(color: C.secondary)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: const Row(
              children: [
                Expanded(
                  child: Stat(value: '2,480', label: 'النقاط'),
                ),
                Expanded(
                  child: Stat(value: '78%', label: 'الدقة'),
                ),
                Expanded(
                  child: Stat(value: '126', label: 'الترتيب'),
                ),
              ],
            ),
          ),
...
class PageTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Icon(Icons.tune_rounded, color: C.secondary),
        const Spacer(),
        Text(
          title,
        ...
        const Spacer(),
        const Icon(Icons.more_horiz_rounded, color: C.secondary),
      ],
    );
  }
}
