...
void main() {
  ...
  test('submission is rejected when an EARLIER round in the same season is '
      'still open — the sequential-round gate (a season opens all its rounds '
      'up front, so round_not_open alone cannot catch this)', () async {
  ...
  test('submission succeeds once the earlier round has locked', () async {
    final earlierRoundId = 'ffffffff-ffff-ffff-ffff-ffffffffffff';
    competition.seedRound(
      (Round.open(
                id: const RoundId(_roundId),
