...
abstract interface class LeaderboardRepository {
  ...
  /// Returns the **unranked** all-time projection — one [HallOfFameEntry] per
  /// user with at least one ledger movement, aggregated ACROSS every season
  /// (Axiom 5: the SAME append-only ledger, no new points source). Capped at
  /// [limit] (already clamped by the use-case) so this never triggers an
