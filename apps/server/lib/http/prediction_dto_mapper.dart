...
///
/// This mapping lives here, once, so all three prediction read surfaces — the
/// single "my prediction" (`GET /rounds/{id}/predictions`), the locked-round
/// list (`GET /rounds/{id}/predictions/all`), and the caller's own aggregated
/// history (`GET /me/predictions`) — shape a prediction identically.
///
