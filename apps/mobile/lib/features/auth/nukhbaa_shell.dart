...
border: Border.all(
color: NukhbaaColors.purple.withValues(alpha: .55),
),
boxShadow: [
BoxShadow(
...
@override
State<NukhbaaPredictionsPage> createState() =>
_NukhbaaPredictionsPageState();
}

class _NukhbaaPredictionsPageState
extends State<NukhbaaPredictionsPage> {
int homeScore = 2;
int awayScore = 1;
...
Text(
'ثقتك: ${confidence >= .7 ? 'عالية' : confidence >= .4 ? 'متوسطة' : 'منخفضة'}',
style: const TextStyle(
color: NukhbaaColors.secondary,
fontSize: 11,
),
