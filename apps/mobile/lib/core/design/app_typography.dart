...
abstract final class AppTypography {
  ...
  static const TextTheme textTheme = TextTheme(
    ...
    titleSmall:     TextStyle(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.10),
    ...
    labelLarge:     TextStyle(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.10),
    labelMedium:    TextStyle(fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: 0.50),
    labelSmall:     TextStyle(fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: 0.50),
  );
}
