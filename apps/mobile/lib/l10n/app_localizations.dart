...
abstract class AppLocalizations {
  ...
  /// No description provided for @adminMonthlyCompetitionsTab.
  ///
  /// In en, this message translates to:
  /// **'Monthly Competitions'**
  String get adminMonthlyCompetitionsTab;

  /// No description provided for @adminPredictionsTab.
  ///
  /// In en, this message translates to:
  /// **'Predictions'**
  String get adminPredictionsTab;

  /// No description provided for @adminDailyDoublesTab.
  ///
  /// In en, this message translates to:
  /// **'Daily Doubles'**
  String get adminDailyDoublesTab;

  /// No description provided for @adminLeaderboardsTab.
  ///
  /// In en, this message translates to:
  /// **'Leaderboards'**
  String get adminLeaderboardsTab;

  /// No description provided for @adminCompetitionsTab.
  ///
  /// In en, this message translates to:
  /// **'Competitions'**
  String get adminCompetitionsTab;

  /// No description provided for @adminTeamsTab.
  ///
  /// In en, this message translates to:
  /// **'Teams'**
  String get adminTeamsTab;

  /// No description provided for @adminSocialTab.
  ///
  /// In en, this message translates to:
  /// **'Social'**
  String get adminSocialTab;
  ...
  /// No description provided for @adminReportsAnalyticsTab.
  ///
  /// In en, this message translates to:
  /// **'Reports & Analytics'**
  String get adminReportsAnalyticsTab;

  /// No description provided for @adminSystemHealthTab.
  ///
  /// In en, this message translates to:
  /// **'System Health'**
  String get adminSystemHealthTab;

  /// No description provided for @adminRolesPermissionsTab.
  ///
  /// In en, this message translates to:
  /// **'Roles & Permissions'**
  String get adminRolesPermissionsTab;

  /// No description provided for @adminSettingsTab.
  ///
  /// In en, this message translates to:
  /// **'Settings'**
  String get adminSettingsTab;
